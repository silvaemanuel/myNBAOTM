...
prx.types.material_chip_complex = {
    ...
    ,onDisplay: function(item,containerid,symbol) {
        ...
        cR += '#' + _id + ' .material-chip-text-wrapper { '+prx.componentsHelper.getProp(item.textFont,'font-family')+' color: '+prx.componentsHelper.getProp(item.textColor,'color-text')+'; font-size: '+prx.componentsHelper.getProp(item.textSize,'num-text-size')+'px; text-align: '+prx.componentsHelper.getProp(item.textAlign,'align')+';}';
        ...
        // text
        cR += '<div class="material-chip-text-wrapper liveUpdate-textColor-color changeProperty-textColor changeProperty-textSize changeProperty-textFont changeProperty-textAlign">';
...
prx.types.material_textfield = {
	...
	,onDisplay: function(item,containerid,symbol) {
		...
		if(prx.editor) {
			...
			cR += '<div class="faux-input liveUpdate-textColor-color liveUpdate-borderColor-border-color changeProperty-textColor changeProperty-borderColor" data-editableproperty="value">'+prx.componentsHelper.getProp(item.value,'text')+'</div>';
...
prx.types.material_textarea = {
	...
	,onDisplay: function(item,containerid,symbol) {
        ...
        cR += '#'+_id+' .material-textarea-bg-wrapper { width: 100%; height: 100%; '+prx.gradients.getBgCssByProperty(item.backgroundColor,'color-background')+'; }';
        if(prx.componentsHelper.getProp(item.isFull,'boolean')) {
		...
		if(prx.editor) {
			if(prx.componentsHelper.getProp(item.hasLabel,'boolean')) {
			cR += '<div class="label liveUpdate-labelColor-color changeProperty-labelColor changeProperty-labelSize changeProperty-labelAlign" data-editableproperty="label">'+prx.componentsHelper.getProp(item.label,'text-textarea')+'</div>';
			}
			cR += '<div class="faux-input liveUpdate-textColor-color liveUpdate-borderColor-border-color" data-editableproperty="value">'+prx.componentsHelper.getProp(item.value,'text-textarea')+'</div>';
			...
			cR += '<textarea class="real-input liveUpdate-placeholderColor-color liveUpdate-textColor-color liveUpdate-borderColor-color changeProperty-borderColor changeProperty-borderWidth changeProperty-borderRadius changeProperty-textSize changeProperty-textFont changeProperty-textColor changeProperty-textAlign" placeholder="'+prx.componentsHelper.getProp(item.placeholder,'other')+'" data-role="none">'+prx.componentsHelper.getProp(item.value,'text-textarea').replace(/<br \/>/g, "\n")+'</textarea>'
		}
...
prx.types.material_textfield_floating_label = {
    ...
    ,onDisplay: function(item,containerid,symbol) {
        ...
        if(prx.editor) {
            ...
            cR += '<div class="faux-input '+((prx.componentsHelper.getProp(item.fieldtype,'other')== 'textarea') ? 'textarea ' : '')+'liveUpdate-textColor-color liveUpdate-borderColor-border-color liveUpdate-backgroundColor-background-color" data-editableproperty="value">'+((prx.componentsHelper.getProp(item.fieldtype,'other') != 'textarea')  ? prx.componentsHelper.getProp(item.value,'text') : prx.componentsHelper.getProp(item.value,'text-textarea')) +'</div>';
            cR += '<div class="label '+((prx.componentsHelper.getProp(item.fieldtype,'other') == 'textarea') ? 'textarea ' : '')+'liveUpdate-labelColor-color changeProperty-labelAlign changeProperty-labelFont">'+prx.componentsHelper.getProp(item.label,'other')+'</div>'
            cR += '</div>';
        }
        else {
            cR += '<div class="material-floating-label-field-wrapper">';
            if(prx.componentsHelper.getProp(item.fieldtype,'other') == 'input') {
                ...
                cR += '<textarea data-role="none" class="real-input liveUpdate-textColor-color liveUpdate-borderColor-border-color changeProperty-borderColor changeProperty-borderColorActive changeProperty-borderWidth changeProperty-borderRadius changeProperty-textSize changeProperty-textFont changeProperty-textColor changeProperty-textAlign">'+prx.componentsHelper.getProp(item.value,'text-textarea').replace(/<br \/>/g, "\n")+'</textarea>'
            }
            cR += '<div class="label '+((prx.componentsHelper.getProp(item.fieldtype,'other') == 'textarea') ? 'textarea ' : '')+'liveUpdate-labelColor-color changeProperty-labelAlign changeProperty-labelFont changeProperty-labelColor">'+prx.componentsHelper.getProp(item.label,'other')+'</div>'
            cR += '</div>';
        }
		cR += prx.items.getComponentAppendDivs(item, containerid, symbol);
        cR += '</div>';
...
prx.types.material_textarea_floating_label = {
    ...
    ,onDisplay: function(item,containerid,symbol) {
        ...
        if(prx.editor) {
            ...
            cR += '<div class="label textarea liveUpdate-labelColor-color changeProperty-labelAlign changeProperty-labelFont">'+prx.componentsHelper.getProp(item.label,'other')+'</div>'
            cR += '</div>';
        }
        else {
            cR += '<div class="material-floating-label-field-wrapper">';
	...
	,afterDisplay: function(item,containerid,symbol) {
		...
		if(!prx.editor) {
            ...
            if(_isCheckboxAndRadioGrouped) {
                ...
                $('label[for="'+_id+'-checkbox"]').on('click change', function(event) {
                    event.preventDefault();
                });
...
prx.types.material_bottomsheet_complex = {
	...
	,onDisplay: function(item,containerid,symbol) {
		...
		cR += '<div class="material-bottomsheet-inner liveUpdate-backgroundColor-background-color changeProperty-backgroundColor changeProperty-textAlign changeProperty-textFont changeProperty-textSize">';
		...
		$.each(item.listitems, function(i,elm){
			...
			if(prx.componentsHelper.getProp(elm.itemtype,'other') == 'separator') {
				...
				cR += '<div class="material-bottomsheet-subtitle liveUpdate-subtitleColor-color changeProperty-subtitleColor changeProperty-subtitleFont changeProperty-subtitleSize">';
...
prx.types.material_list_complex = {
	...
	,onDisplay: function(item,containerid,symbol) {
		...
		$.each(item.listitems, function(i,elm){
			...
			cR += '<span data-editableproperty="text" data-dynamic-property-index="'+i+'">'+prx.componentsHelper.getProp(elm.text,'text-textarea')+'</span>';
			cR += '</div>';
			cR += '<div class="material-list-subtitle liveUpdate-textColorSubtitle-color changeProperty-textColorSubtitle changeProperty-textFontSubtitle changeProperty-textSizeSubtitle">';
			cR += '<span data-editableproperty="subtitle" data-dynamic-property-index="'+i+'">'+prx.componentsHelper.getProp(elm.subtitle,'text-textarea')+'</span>';
			cR += '</div>';
			cR += '</div>';
...
prx.types.material_ripple = {
	...
	,onDisplay: function(item,containerid,symbol) {
		...
		cR += '<div class="inner-rec liveUpdate-rippleEffectColor-background-color prx-material-ripple '+((prx.componentsHelper.getProp(item.circ,'boolean')) ? 'type-material-ripple-circ' : '')+' '+((prx.editor) ? 'in-editor' : 'in-player')+'"><div></div></div>';
		cR += prx.items.getComponentAppendDivs(item, containerid, symbol);
		cR += '</div>';
		return cR;
	}
...
prx.types.material_dialog_alert = {
	...
	,onDisplay: function(item,containerid,symbol) {
		...
		if(item.withTitle) {
		cR += '<div class="material-dialog-title liveUpdate-titleColor-color changeProperty-titleColor changeProperty-titleSize changeProperty-textFont"><span data-editableproperty="title">'+prx.componentsHelper.getProp(item.title,'text-textarea')+'</span></div>';
		}
...
prx.types.material_dialog_simpledialog = {
	...
	,onDisplay: function(item,containerid,symbol) {
		...
		cR += '<div class="material-simple-dialog-inner liveUpdate-backgroundColor-background-color changeProperty-backgroundColor changeProperty-textAlign changeProperty-textFont changeProperty-textSize">';
		...
		$.each(item.listitems, function(i,elm){
			...
			cR += '<div class="material-simple-dialog-text liveUpdate-textColor-color changeProperty-textColor">';
			cR += '<span data-editableproperty="text" data-dynamic-property-index="'+i+'">'+prx.componentsHelper.getProp(elm.text,'text-textarea')+'</span>';
			cR += '</div>';
			cR += '</div>';
			cR += '</div>';
